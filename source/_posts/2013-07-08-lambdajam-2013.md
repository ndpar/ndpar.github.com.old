...
- The point is, it makes it comprehensible what is badly expressed in the traditional form.
...
- Gerald Jay Sussman, Jack Wisdom — Functional Differential Geometry [[book](http://mitpress.mit.edu/books/functional-differential-geometry)].
...
- Emily Bache — An introduction to Array Languages [[blogpost](http://coding-is-like-cooking.info/2013/09/an-introduction-to-array-languages/)].
- Bryan Cantrilla — Conversation with Arthur Whitney [[html](http://queue.acm.org/detail.cfm?id=1531242)]
...
- We sick of the status quo, and there is a resurgence among engineers and excitment around new programming languages.
